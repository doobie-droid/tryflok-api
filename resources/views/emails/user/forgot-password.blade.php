							...
							<tr>
								<td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
										<tr>
											<td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
												<a href="{{ join_path(env('FRONTEND_URL', 'https://akiddie.com.ng'), 'password/reset/' . $user['password_token']) }}" class="f-fallback button" target="_blank" style="color: #FFF; border-color: #276db8; border-style: solid; border-width: 10px 18px; background-color: #276db8; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Reset Password</a>
											</td>
										</tr>
									</table>
								</td>
						...
						<table class="body-sub" role="presentation" style="margin-top: 25px; padding-top: 25px; border-top-width: 1px; border-top-color: #EAEAEC; border-top-style: solid;">
							<tr>
								<td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
									...
									<p class="f-fallback sub" style="font-size: 13px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">{{ join_path(env('FRONTEND_URL', 'https://akiddie.com.ng'), 'password/reset/' . $user['password_token']) }}</p>
								</td>
							</tr>
						</table>
					</div>
