                ...
                <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                    <div class="f-fallback">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
							<tr>
								<td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
												<a href="{{ join_path(config('flok.frontend_url'), 'email/verify/new/' . $user['email_token']) }}" class="f-fallback button" target="_blank" style="color: #FFF; border-color: #6E4CF5; border-style: solid; border-width: 10px 18px; background-color: #6E4CF5; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Confirm your email</a>
											</td>
										</tr>
									</table>
								</td>
						...
						<table class="body-sub" role="presentation" style="margin-top: 25px; padding-top: 25px; border-top-width: 1px; border-top-color: #EAEAEC; border-top-style: solid;">
							<tr>
								<td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
									...
									<p class="f-fallback sub" style="font-size: 13px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">{{ join_path(config('flok.frontend_url'), 'email/verify/new/' . $user['email_token']) }}</p>
								</td>
							</tr>
						</table>
					</div>
