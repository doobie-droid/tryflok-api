...
{
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?page=ere");
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?page=-10");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?limit=ere");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?limit=-30");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?limit={$max_limit_exceed}");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?keyword={$keyword_excess}");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?tags=fdfr3-3434f-434,dfdrg-2323-frf");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
        ...
        $response = $this->json('GET', "/api/v1/collections/{$this->digiverse->id}/contents?creators=fdfr3-3434f-434,dfdrg-2323-frf");
        $response->assertStatus(400)
        ->assertJsonStructure([
            'status',
            'message',
...
test('unavailable contents do not get returned if user is not owner', function()
{
        ...
        ->count(4)
        ->create();
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?page=1&limit=10");
...
test('unavailable contents get returned if user is owner', function()
{
    ...
    $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?page=1&limit=2");
    $response->assertStatus(200)
    ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
    $contents = $response->getData()->data->contents;
    ...
    $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?page=2&limit=2");
    $response->assertStatus(200)
    ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
    $contents = $response->getData()->data->contents;
...
{       
        ...
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?tags={$tag1->id}");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        ...
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?tags={$tag2->id}");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        $this->assertTrue(count($response->getData()->data->contents) === 1);
        $contents = $response->getData()->data->contents;
...
test('filter by keywords work', function()
{
        ...
        $content3 = Models\Content::factory()
            ...
            ->setTags([Models\Tag::factory()->create()])
            ->create();
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?keyword=title1 title3");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        $contents = $response->getData()->data->contents;
        ...
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?keyword=title2 title3");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        $contents = $response->getData()->data->contents;
        $this->assertEquals(count($contents), 2);
...
test('filter by creators works', function()
{
        ...
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?creators={$user1->id},{$user3->id}");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        $contents = $response->getData()->data->contents;
        $this->assertEquals(count($contents), 2);
        ...
        $response = $this->json('GET', "/api/v1/collections/{$digiverse->id}/contents?creators={$user2->id},{$user3->id}");
        $response->assertStatus(200)
        ->assertJsonStructure(MockData\Content::generateGetDigiverseContentsResponse());
        $contents = $response->getData()->data->contents;
        $this->assertEquals(count($contents), 2);
